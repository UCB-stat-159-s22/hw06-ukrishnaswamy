...
#plotting function
def plotty(make_plots=True, det, strain_L1_whitenbp, strain_H1_whitenbp, time, timemax, tevent, SNR, strain_whitenbp, template_match, template_fft, d_eff, datafreq, template_f, freqs, data_psd, eventname, plottype, fs):
